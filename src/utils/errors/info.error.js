export const generateProductErrorInfo = (product) => {
  return `One or more properties are incomplete or invalid!!! List of mandatory properties: Title: Must be a string. (Type:${typeof product.title}). Description: Must be a string. (Type:${typeof product.description}). Category: Must be a string. (Type:${typeof product.category}). Price: Must be a string. (Type:${typeof product.price}). Thumbnail: Must be a string. (Type:${typeof product.thumbnail}). Code: Must be a string. (Type:${typeof product.code}). Stock: Must be a number. (Type:${typeof product.stock})`
}
export const generateUserErrorInfo = (user) => {
  return `One or more properties are incomplete or invalid!!! List of mandatory properties: firstName: Must be a string. (Type:${typeof user.firstName}). lastName: Must be a string. (Type:${typeof user.lastName}). email: Must be a string. (Type:${typeof user.email}). password: Must be a string. (Type:${typeof user.password}). age: Must be a number. (Type:${typeof user.age}). rol: Must be a string. (Type:${typeof user.rol}). cart: Must be a string. (Type:${typeof user.cart})`
}
